...
const translations = {
    ko: {
        ...
        'btn.downloadRecording': '녹화 영상 다운로드',
        'btn.recordingPreparing': '녹화 영상 준비중 ...',
        'recording.secondsLeft': (n) => `${n}초`,
        'btn.reset': '다시하기',
        'label.record': '레이스 녹화하기',
        'note.recordPcOnly': 'PC 브라우저에서만 지원됩니다',
    ...
    en: {
        ...
        'btn.downloadRecording': 'Download Recording',
        'btn.recordingPreparing': 'Preparing recording ...',
        'recording.secondsLeft': (n) => `${n}s`,
        'btn.reset': 'Play Again',
        'label.record': 'Record the race',
        'note.recordPcOnly': 'Supported on desktop browsers only',
